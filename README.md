# 🚀 Task 09 - Dynamic Content Validation

> A comprehensive Playwright automation task built with JavaScript, covering the **Dynamic Content Validation** functionality using industry-standard automation practices.
...
![Progress](https://img.shields.io/badge/Task-09-blue)

---

# 📌 Project Overview

This repository contains the **Dynamic Content Validation** Playwright automation task developed using **JavaScript**.

The goal of this task is to validate that the application displays updated dynamic content after refreshing the page while following industry-standard automation framework practices and Git workflows.
...
```bash
npx playwright test tests/Task_09_Dynamic_Content/DynamicContent.spec.js
```

Run in headed mode

```bash
npx playwright test tests/Task_09_Dynamic_Content/DynamicContent.spec.js --headed
```

Run in debug mode

```bash
npx playwright test tests/Task_09_Dynamic_Content/DynamicContent.spec.js --debug
```
...
![Old Dynamic Content](docs/Task_09_Dynamic_Content/oldContent.png)

---

## Updated Dynamic Content

![Updated Dynamic Content](docs/Task_09_Dynamic_Content/newContent.png)

---

## 📊 Playwright HTML Report

![Playwright Report](docs/Task_09_Dynamic_Content/Playwright_Report.png)
