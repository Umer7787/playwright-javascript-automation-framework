# 🚀 Task 07 - Dropdown Selection

> A comprehensive Playwright automation task built with JavaScript, covering the **Dropdown Selection** functionality using industry-standard automation practices.
...
![Progress](https://img.shields.io/badge/Task-07-blue)

---

# 📌 Project Overview

This repository contains the **Dropdown Selection** Playwright automation task developed using **JavaScript**.

The goal of this task is to validate that a user can successfully select an option from the dropdown list while following industry-standard automation framework practices and Git workflows.
...
```bash
npx playwright test tests/Task_07_Dropdown_Selection/DropdownSelection.spec.js
```

Run in headed mode

```bash
npx playwright test tests/Task_07_Dropdown_Selection/DropdownSelection.spec.js --headed
```

Run in debug mode

```bash
npx playwright test tests/Task_07_Dropdown_Selection/DropdownSelection.spec.js --debug
```
...
![Home Page](docs/Task_07_Dropdown_Selection/HomePage.png)

---

## Dropdown Selection

![Dropdown Selection](docs/Task_07_Dropdown_Selection/DropdownList.png)

---

## 📊 Playwright HTML Report

![Playwright Report](docs/Task_07_Dropdown_Selection/Playwright_Report.png)
