# 🚀 Task 10 - Verify Image Visibility
...
This repository contains the **Verify Image Visibility** Playwright automation task developed using **JavaScript**.

The goal of this task is to validate that the homepage logo is visible after the application loads while following industry-standard automation framework practices and Git workflows.
...
![Home Page](docs/Task_10_Verify_Image/HomePage.png)

---

## 📊 Playwright HTML Report

![Playwright Report](docs/Task_10_Verify_Image/Playwright_Report.png)
