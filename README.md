# 🚀 Task 04 - Checkbox Validation

> A comprehensive Playwright automation task built with JavaScript, covering the **Checkbox Validation** functionality using industry-standard automation practices.
...
![Progress](https://img.shields.io/badge/Task-04-blue)

---

# 📌 Project Overview

This repository contains the **Checkbox Validation** Playwright automation task developed using **JavaScript**.

The goal of this task is to validate that the checkbox is successfully selected while following industry-standard automation framework practices and Git workflows.
...
```bash
npx playwright test tests/Task_04_Checkbox_Validation/CheckboxValidation.spec.js
```

Run in headed mode

```bash
npx playwright test tests/Task_04_Checkbox_Validation/CheckboxValidation.spec.js --headed
```

Run in debug mode

```bash
npx playwright test tests/Task_04_Checkbox_Validation/CheckboxValidation.spec.js --debug
```
...
![Home Page](docs/Task_04_Checkbox_Validation/HomePage.png)

---

## Checkbox Validation

![Checkbox Validation](docs/Task_04_Checkbox_Validation/CheckBox.png)

---

## 📊 Playwright HTML Report

![Playwright Report](docs/Task_04_Checkbox_Validation/Playwright_Report.png)
