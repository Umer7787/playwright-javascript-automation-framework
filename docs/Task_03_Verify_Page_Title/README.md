# 🚀 Task 03 - Verify Page Title

> A comprehensive Playwright automation task built with JavaScript, covering the **Verify Page Title** functionality using industry-standard automation practices.
...
![Progress](https://img.shields.io/badge/Task-03-blue)

---

# 📌 Project Overview

This repository contains the **Verify Page Title** Playwright automation task developed using **JavaScript**.

The goal of this task is to validate that the application displays the correct page title while following industry-standard automation framework practices and Git workflows.
...
```bash
npx playwright test tests/Task_03_Verify_Page_Title/VerifyPageTitle.spec.js
```

Run in headed mode

```bash
npx playwright test tests/Task_03_Verify_Page_Title/VerifyPageTitle.spec.js --headed
```

Run in debug mode

```bash
npx playwright test tests/Task_03_Verify_Page_Title/VerifyPageTitle.spec.js --debug
```
