# 🚀 Task 06 - Text Box Validation

> A comprehensive Playwright automation task built with JavaScript, covering the **Text Box Validation** functionality using industry-standard automation practices.
...
![Progress](https://img.shields.io/badge/Task-06-blue)

---

# 📌 Project Overview

This repository contains the **Text Box Validation** Playwright automation task developed using **JavaScript**.

The goal of this task is to validate that the user can successfully enter details into the text box fields and verify the submitted information while following industry-standard automation framework practices and Git workflows.
...
```bash
npx playwright test tests/Task_06_Text_Box/TextBox.spec.js
```

Run in headed mode

```bash
npx playwright test tests/Task_06_Text_Box/TextBox.spec.js --headed
```

Run in debug mode

```bash
npx playwright test tests/Task_06_Text_Box/TextBox.spec.js --debug
```
...
![Text Box Validation](TextBoxFill.png)
